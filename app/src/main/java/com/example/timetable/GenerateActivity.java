...
import com.example.timetable.mtimes.TtimeTableGenerator;
...
public class GenerateActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.bt_generate).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        tableGenerator.generateTimetable(getSamister(), GenerateActivity.this);
    }
